...
exports.app.post("/api/add-workout", async (req, res) => {
    var _a;
    try {
        // Get user token from request
        const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
        ...
        const user = await exports.collection.findOne({ email: decoded.email });
        ...
        const result = await exports.collection.updateOne({ email: decoded.email }, { $push: { workouts: workout } });
